...
"""Script for verifying Navcoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
navcoincore.org and navcoin.org and compares them.
...
WORKINGDIR = "/tmp/navcoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://navcoincore.org"
HOST2 = "https://navcoin.org"
VERSIONPREFIX = "navcoin-core-"
...
def main(args):
    ...
    if not success:
        print("navcoin.org failed to provide signature file, "
              "but navcoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("navcoin.org and navcoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Navcoin Core binary release "
