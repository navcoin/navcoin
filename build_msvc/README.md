...
```cmd
msbuild -property:Configuration=Release -maxCpuCount -verbosity:minimal navcoin.sln
```

Alternatively, open the `build_msvc/navcoin.sln` file in Visual Studio 2019.
