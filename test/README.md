...
navcoind and navcoin-qt by interacting with them through the RPC and P2P
interfaces.
...
Before tests can be run locally, Navcoin Core must be built.  See the [building instructions](/doc#building) for help.
