...
class P2PPermissionsTests(NavcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].navcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].navcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
