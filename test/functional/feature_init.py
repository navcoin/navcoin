...
from test_framework.test_framework import NavcoinTestFramework, SkipTest
from test_framework.test_node import ErrorMatch
from test_framework.util import assert_equal


class InitStressTest(NavcoinTestFramework):
    """
    ...
    def run_test(self):
        ...
        for file_patt, err_fragment in files_to_disturb.items():
            ...
            #
            # At the moment I can't get this to work (navcoind loads successfully?) so
