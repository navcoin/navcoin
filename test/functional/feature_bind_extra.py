...
"""
Test starting navcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(NavcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that navcoind has bound on "::1" (for RPC) and "::" (for P2P).
