...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the NavcoinTestFramework
    pass


class ExampleTest(NavcoinTestFramework):
    # Each functional test is a subclass of the NavcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        NavcoinTestFramework class so other tests can use it."""
