...
"""Verify that starting navcoin with -h works as expected."""

from test_framework.test_framework import NavcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(NavcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start navcoin with -h for help text")
        ...
        self.log.info("Start navcoin with -version for version information")
        ...
        self.log.info("Start navcoind with -fakearg to make sure it does not start")
