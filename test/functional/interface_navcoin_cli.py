...
class TestNavcoinCli(NavcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `navcoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and navcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and navcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test navcoin-cli -generate with -rpcwallet in multiwallet mode.
