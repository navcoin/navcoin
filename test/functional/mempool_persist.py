...
By default, navcoind will dump mempool on shutdown and
...
class MempoolPersistTest(NavcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent navcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
