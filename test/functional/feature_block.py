...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure naviod isn't accepting b26
        ...
        # Extend the b28 chain to make sure naviod isn't accepting b28
...
#       self.send_blocks([b47], False, force_send=True, reject_reason='high-hash', reconnect=True)
        ...
        tx = CTransaction()
        tx.vin.append(CTxIn(COutPoint(duplicate_tx.vout[0].hash())))
        ...
        tx.vin.append(CTxIn(COutPoint(out[18].vout[0].hash())))  # don't set nSequence
        tx.vout.append(CTxOut(0, CScript([OP_TRUE])))
        ...
        # naviod doesn't disconnect us for sending a bloated block, but if we subsequently
