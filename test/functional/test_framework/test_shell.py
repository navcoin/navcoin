...
class TestShell:
    """Wrapper Class for NavcoinTestFramework.

    The TestShell class extends the NavcoinTestFramework
    ...
    class __TestShell(NavcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by NavcoinTestFramework child class.
            self.num_nodes = 1
