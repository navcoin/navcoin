...
MclTestingSetup::MclTestingSetup(const std::string& chainName, const std::vector<const char*>& extra_args) : BasicTestingSetup(chainName, extra_args)
{
    MclInitializer::Init();
    MclG1Point::Init();
}
...
ChainTestingSetup::ChainTestingSetup(const std::string& chainName, const std::vector<const char*>& extra_args)
    : MclTestingSetup(chainName, extra_args)
{
