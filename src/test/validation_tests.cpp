...
BOOST_AUTO_TEST_CASE(block_malleation)
{
...

    {
        ...
        block.vtx.clear();
        {
            ...
            mtx.vin.resize(1);
            mtx.vout.resize(1);
            // navio inputs serialize without an output index (37 bytes), so an
            // 8-byte script makes the transaction 64 bytes.
            mtx.vout[0].scriptPubKey.resize(8);
...

    {
        ...
        // empty transactions with a random version field. These vectors were
        // mined for navio's serialization: tx3 decodes as a transaction with
        // no inputs and one output carrying a 45-byte script.
        CMutableTransaction tx1;
        BOOST_CHECK(DecodeHexTx(tx1, "502180b4000000000000", /*try_no_witness=*/true, /*try_witness=*/false));
        CMutableTransaction tx2;
        BOOST_CHECK(DecodeHexTx(tx2, "8955a1f7000000000000", /*try_no_witness=*/true, /*try_witness=*/false));
        CMutableTransaction tx3;
        BOOST_CHECK(DecodeHexTx(tx3, "4a9175c6000179a844e6de44deba2d820e567328d54a60809f333ad633c917d97ae42a22881e2a7afd699ccf43795d7dacebb2a2a0730d2974ea8b5af242d324", /*try_no_witness=*/true, /*try_witness=*/false));
        {
