...
BOOST_AUTO_TEST_CASE(test_FormatSubVersion)
{
    ...
    comments2.emplace_back(std::string("comment1"));
    comments2.emplace_back(SanitizeString(std::string("Comment2; .,_?@-; !\"#$%&'()*+/<=>[]\\^`{|}~"), SAFE_CHARS_UA_COMMENT)); // Semicolon is discouraged but not forbidden by BIP-0014
