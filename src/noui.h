...
/** Connect all navcoind signal handlers */
void noui_connect();

/** Redirect all navcoind signal handlers to LogPrintf. Used to check or suppress output during test runs that produce expected errors */
