 ...
 * for both navcoind and navcoin-qt, to make it harder for attackers to
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Navcoin Core copyright is not removed by accident
    if (copyright_devs.find("Navcoin Core") == std::string::npos) {
