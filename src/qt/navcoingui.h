...
public:
    ...
    explicit NavcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~NavcoinGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Navcoin Transaction from file or clipboard */
