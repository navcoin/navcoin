...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, NavcoinUnits::SeparatorStyle separators=NavcoinUnits::SeparatorStyle::STANDARD) const;
