...
void AppTests::appTests()
{
    ...
    connect(&m_app, &NavcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for NavcoinGUI tests.
void AppTests::guiTests(NavcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &NavcoinGUI::consoleShown, this, &AppTests::consoleTests);
