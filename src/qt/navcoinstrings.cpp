...
"%s corrupt. Try using the wallet tool navcoin-wallet to salvage or restoring "
"a backup."),
QT_TRANSLATE_NOOP("navcoin-core", ""
...
QT_TRANSLATE_NOOP("navcoin-core", ""
"Error: Dumpfile version is not supported. This version of navcoin-wallet "
...
QT_TRANSLATE_NOOP("navcoin-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("navcoin-core", "-maxmempool must be at least %d MB"),
QT_TRANSLATE_NOOP("navcoin-core", "A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("navcoin-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Cannot set -forcednsseed to true when setting -dnsseed to false."),
QT_TRANSLATE_NOOP("navcoin-core", "Cannot set -peerblockfilters without -blockfilterindex."),
QT_TRANSLATE_NOOP("navcoin-core", "Cannot write to data directory '%s'; check permissions."),
QT_TRANSLATE_NOOP("navcoin-core", "Config setting for %s only applied on %s network when in [%s] section."),
QT_TRANSLATE_NOOP("navcoin-core", "Copyright (C) %i-%i"),
QT_TRANSLATE_NOOP("navcoin-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("navcoin-core", "Could not find asmap file %s"),
QT_TRANSLATE_NOOP("navcoin-core", "Could not parse asmap file %s"),
QT_TRANSLATE_NOOP("navcoin-core", "Disk space is too low!"),
QT_TRANSLATE_NOOP("navcoin-core", "Do you want to rebuild the block database now?"),
QT_TRANSLATE_NOOP("navcoin-core", "Done loading"),
QT_TRANSLATE_NOOP("navcoin-core", "Dump file %s does not exist."),
QT_TRANSLATE_NOOP("navcoin-core", "Error creating %s"),
...
QT_TRANSLATE_NOOP("navcoin-core", "Error loading %s: Private keys can only be disabled during creation"),
...
QT_TRANSLATE_NOOP("navcoin-core", "Error reading next record from wallet database"),
QT_TRANSLATE_NOOP("navcoin-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Couldn't create cursor into database"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Disk space is low for %s"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Dumpfile checksum does not match. Computed %s, expected %s"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Got key that was not hex: %s"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Got value that was not hex: %s"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Missing checksum"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: No %s addresses available."),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Unable to parse version %u as a uint32_t"),
QT_TRANSLATE_NOOP("navcoin-core", "Error: Unable to write record to new wallet"),
QT_TRANSLATE_NOOP("navcoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("navcoin-core", "Failed to rescan the wallet during initialization"),
QT_TRANSLATE_NOOP("navcoin-core", "Failed to verify database"),
QT_TRANSLATE_NOOP("navcoin-core", "Fee rate (%s) is lower than the minimum fee rate setting (%s)"),
QT_TRANSLATE_NOOP("navcoin-core", "Ignoring duplicate -wallet %s."),
...
QT_TRANSLATE_NOOP("navcoin-core", "Input not found or already spent"),
QT_TRANSLATE_NOOP("navcoin-core", "Insufficient funds"),
QT_TRANSLATE_NOOP("navcoin-core", "Invalid -i2psam address or hostname: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Invalid -onion address or hostname: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Invalid -proxy address or hostname: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Invalid P2P permission: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Invalid amount for -%s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Invalid amount for -discardfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("navcoin-core", "Loading P2P addresses…"),
...
QT_TRANSLATE_NOOP("navcoin-core", "Missing amount"),
QT_TRANSLATE_NOOP("navcoin-core", "Missing solving data for estimating transaction size"),
QT_TRANSLATE_NOOP("navcoin-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "No addresses available"),
QT_TRANSLATE_NOOP("navcoin-core", "No proxy server specified. Use -proxy=<ip> or -proxy=<ip:port>."),
...
QT_TRANSLATE_NOOP("navcoin-core", "Prune mode is incompatible with -coinstatsindex."),
...
QT_TRANSLATE_NOOP("navcoin-core", "Replaying blocks…"),
QT_TRANSLATE_NOOP("navcoin-core", "Rescanning…"),
QT_TRANSLATE_NOOP("navcoin-core", "SQLiteDatabase: Failed to execute statement to verify database: %s"),
QT_TRANSLATE_NOOP("navcoin-core", "SQLiteDatabase: Failed to prepare statement to verify database: %s"),
QT_TRANSLATE_NOOP("navcoin-core", "SQLiteDatabase: Failed to read database verification error: %s"),
QT_TRANSLATE_NOOP("navcoin-core", "SQLiteDatabase: Unexpected application id. Expected %u, got %u"),
QT_TRANSLATE_NOOP("navcoin-core", "Section [%s] is not recognized."),
QT_TRANSLATE_NOOP("navcoin-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("navcoin-core", "Specified -walletdir \"%s\" does not exist"),
QT_TRANSLATE_NOOP("navcoin-core", "Specified -walletdir \"%s\" is a relative path"),
QT_TRANSLATE_NOOP("navcoin-core", "Specified -walletdir \"%s\" is not a directory"),
QT_TRANSLATE_NOOP("navcoin-core", "Specified blocks directory \"%s\" does not exist."),
QT_TRANSLATE_NOOP("navcoin-core", "Starting network threads…"),
QT_TRANSLATE_NOOP("navcoin-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("navcoin-core", "The specified config file %s does not exist"),
QT_TRANSLATE_NOOP("navcoin-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("navcoin-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("navcoin-core", "This is experimental software."),
QT_TRANSLATE_NOOP("navcoin-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("navcoin-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("navcoin-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("navcoin-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("navcoin-core", "Transaction change output index out of range"),
QT_TRANSLATE_NOOP("navcoin-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("navcoin-core", "Transaction must have at least one recipient"),
QT_TRANSLATE_NOOP("navcoin-core", "Transaction needs a change address, but we can't generate it."),
...
QT_TRANSLATE_NOOP("navcoin-core", "Unable to create the PID file '%s': %s"),
QT_TRANSLATE_NOOP("navcoin-core", "Unable to generate initial keys"),
QT_TRANSLATE_NOOP("navcoin-core", "Unable to generate keys"),
QT_TRANSLATE_NOOP("navcoin-core", "Unable to open %s for writing"),
QT_TRANSLATE_NOOP("navcoin-core", "Unable to parse -maxuploadtarget: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("navcoin-core", "Unknown -blockfilterindex value %s."),
QT_TRANSLATE_NOOP("navcoin-core", "Unknown address type '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Unknown change type '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("navcoin-core", "Unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("navcoin-core", "Unsupported logging category %s=%s."),
QT_TRANSLATE_NOOP("navcoin-core", "Upgrading UTXO database"),
...
QT_TRANSLATE_NOOP("navcoin-core", "Verifying wallet(s)…"),
