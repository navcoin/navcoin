...
QString NavcoinUnits::longName(int unit)
{
    switch(unit)
    {
...
QString NavcoinUnits::shortName(int unit)
{
    switch(unit)
    {
...
QString NavcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Navcoins");
    case mBTC: return QString("Milli-Navcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Navcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
QString NavcoinUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool justify)
{
...
QString NavcoinUnits::formatWithPrivacy(int unit, const CAmount& amount, SeparatorStyle separators, bool privacy)
{
    assert(amount >= 0);
    QString value;
    if (privacy) {
...
QString NavcoinUnits::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+NavcoinUnits::shortName(unit) + ")";
    }
    return amountTitle;
}
