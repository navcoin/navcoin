...
public:
    ...
    void fixup(QString &input) const override
    {
        ...
        if (valid) {
            ...
            input = NavcoinUnits::format(currentUnit, val, false, NavcoinUnits::SeparatorStyle::ALWAYS);
    ...
    {
        lineEdit()->setText(NavcoinUnits::format(currentUnit, value, false, NavcoinUnits::SeparatorStyle::ALWAYS));
        Q_EMIT valueChanged();
    }
    ...
    void setDisplayUnit(int unit)
    {
        ...
        currentUnit = unit;
        lineEdit()->setPlaceholderText(NavcoinUnits::format(currentUnit, m_min_amount, false, NavcoinUnits::SeparatorStyle::ALWAYS));
        if(valid)
            setValue(val);
        else
            clear();
    ...
    QSize minimumSizeHint() const override
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, NavcoinUnits::format(NavcoinUnits::BTC, NavcoinUnits::maxMoney(), false, NavcoinUnits::SeparatorStyle::ALWAYS));
...
private:
    int currentUnit{NavcoinUnits::BTC};
    CAmount singleStep{CAmount(100000)}; // satoshis
    mutable QSize cachedMinimumSizeHint;
    bool m_allow_empty{true};
    CAmount m_min_amount{CAmount(0)};
    CAmount m_max_amount{NavcoinUnits::maxMoney()};
    ...
    amount(nullptr)
{
    ...
    connect(amount, &AmountSpinBox::valueChanged, this, &NavcoinAmountField::valueChanged);
    connect(unit, qOverload<int>(&QComboBox::currentIndexChanged), this, &NavcoinAmountField::unitChanged);
...
void NavcoinAmountField::SetAllowEmpty(bool allow)
{
    amount->SetAllowEmpty(allow);
}

void NavcoinAmountField::SetMinValue(const CAmount& value)
{
    amount->SetMinValue(value);
}

void NavcoinAmountField::SetMaxValue(const CAmount& value)
{
