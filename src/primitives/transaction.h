...
public:
    ...
    SERIALIZE_METHODS(CTxOut, obj) { READWRITE(obj.nValue, obj.scriptPubKey, obj.valueCommitment); }
...
public:
    ...
    const blsct::Signature balanceSig;
    const blsct::Signature txSig;
