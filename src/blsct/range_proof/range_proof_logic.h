...
struct AmountRecoveryRequest
{
    ...
    static AmountRecoveryRequest<P,S> of(
        RangeProof<P,S>& proof, size_t& index, Point<P>& nonce);
};
...
struct AmountRecoveryResult
{
    ...
    static AmountRecoveryResult<S> failure();
};
...
public:
    ...
    AmountRecoveryResult<S> RecoverAmounts(
