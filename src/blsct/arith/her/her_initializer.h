...
#ifndef NAVCOIN_BLSCT_ARITH_HER_HER_INITIALIZER_H
#define NAVCOIN_BLSCT_ARITH_HER_HER_INITIALIZER_H
...
class HerInitializer : public Initializer<HerInitializer>
{
public:
    static void Init();
...
#endif // NAVCOIN_BLSCT_ARITH_HER_HER_INITIALIZER_H
