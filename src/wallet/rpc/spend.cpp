...
static void ParseRecipients(const UniValue& address_amounts, const UniValue& subtract_fee_outputs, std::vector<CRecipient>& recipients)
{
    ...
    for (const std::string& address : address_amounts.getKeys()) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Navio address: ") + address);
        }
    ...
    return RPCHelpMan{
            ...
            "conf_target, estimate_mode, avoid_reuse, and fee_rate.",
        {
            ...
            {"subtractfeefromamount", RPCArg::Type::BOOL, RPCArg::Default{false}, "The fee will be deducted from the amount being sent.\n"
                                                                                  "The recipient will receive less NAV than you enter in the amount field."},
    ...
    return RPCHelpMan{
            ...
            HELP_REQUIRING_PASSPHRASE,
        {
             ...
             }},
            {
                ...
                {
                    {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "The Navio address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value"},
                },
            },
    ...
    return {
        {
            ...
            "",
            {
                {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the Navio address,\n"
                           ...
                           Cat<std::vector<RPCArg>>(
                               {
                                   ...
                                   {"change_address", RPCArg::Type::STR, RPCArg::DefaultHint{"automatic"}, "The Navio address to receive the change"},
                      ...
                      {
                          {
                              ...
                              {
                                  {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "A Navio address which receives an equal share of the unspecified amount."},
                                  {
                                      "",
                                      RPCArg::Type::OBJ_USER_KEYS,
                                      RPCArg::Optional::OMITTED,
