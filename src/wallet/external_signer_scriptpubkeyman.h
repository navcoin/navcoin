...
#ifndef NAVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define NAVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // NAVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
