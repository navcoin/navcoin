...
#ifndef NAVCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define NAVCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Navcoin Core wallet was originally a collection of unrelated private
...
#endif // NAVCOIN_WALLET_SCRIPTPUBKEYMAN_H
