...
public:
    ...
    static std::vector<std::string> sentence_to_words(const std::string& sentence);

    /* From a vector to a flat string. */
    static std::string words_to_sentence(std::vector<std::string> words);
...
private:
    ...
    // ISO 639-1
    static dict_t en, ja, ko, es, zh_s, zh_t, fr, it, cs, pt;
