...
#ifndef NAVCOIN_WALLET_TRANSACTION_H
#define NAVCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this navcoin node, and set to 0 for transactions that were created
...
#endif // NAVCOIN_WALLET_TRANSACTION_H
