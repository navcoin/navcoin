...
#ifndef NAVCOIN_UTIL_SYSCALL_SANDBOX_H
#define NAVCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during navcoind initialization if Navcoin Core was compiled
...
#endif // NAVCOIN_UTIL_SYSCALL_SANDBOX_H
