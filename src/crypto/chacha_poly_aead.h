...
#ifndef NAVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define NAVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@navcoin.
 *
 ...
 *
 * The chacha20-poly1305@navcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@navcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@navcoin are relatively fast in
...
#endif // NAVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
