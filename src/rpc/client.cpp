...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "generatetoblsctaddress", 0, "nblocks" },
    { "generatetoblsctaddress", 2, "maxtries" },
    ...
    { "aggregatesend", 1, "amount" },
    { "aggregatesend", 2, "max_candidates" },
    ...
    { "setswapintent", 3, "max_size" },
    { "setswapintent", 4, "price_min" },
    { "setswapintent", 5, "expiry" },
    { "clearswapintent", 0, "intent_id" },
    { "requestquote", 2, "size" },
    ...
    { "sendquote", 5, "fill" },
    { "sendquote", 6, "sell_cost" },
    { "sendquote", 7, "order_expiry" },
    { "sendorder", 2, "offer_amount" },
    { "sendorder", 4, "want_amount" },
    { "sendorder", 5, "expiry" },
