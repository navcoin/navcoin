...
#ifndef NAVCOIN_INTERFACES_NODE_H
#define NAVCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a navcoin node (navcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // NAVCOIN_INTERFACES_NODE_H
