...
#ifndef NAVCOIN_INTERFACES_CHAIN_H
#define NAVCOIN_INTERFACES_CHAIN_H
...
//! internal workings of the navcoin node, and not being very convenient to use.
...
#endif // NAVCOIN_INTERFACES_CHAIN_H
