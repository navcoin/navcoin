...
Navcoin Core version *version* is now available from:

  <https://navcoincore.org/bin/navcoin-core-*version*/>
...
using the Linux kernel, macOS 10.15+, and Windows 7 and newer.  Navcoin
