Navcoin-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/navcoin/files/Navcoin/navcoin-0.8.6/
...
- Fix Navcoin-Qt startup crash when clicking dock icon on OSX 
