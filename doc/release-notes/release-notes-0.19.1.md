...
Navcoin Core version 0.19.1 is now available from:

  <https://navcoincore.org/bin/navcoin-core-0.19.1/>
...
From Navcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Navcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Navcoin Core does not yet change appearance when
