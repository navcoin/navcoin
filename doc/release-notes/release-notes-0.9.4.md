Navcoin Core version 0.9.4 is now available from:

  https://navcoin.org/bin/0.9.4/
...
this update is incompatible with the Navcoin system and could lead to consensus
forks.

Navcoin Core released binaries from https://navcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~navcoin/+archive/ubuntu/navcoin
- A third-party or self-compiled Navcoin Core

upgrade to Navcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
