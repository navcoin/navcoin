Navcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/navcoin/files/Navcoin/navcoin-0.5.4/
...
http://gitorious.org/navcoin/navcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Navcoin-Qt notifications under Growl 1.3.
Increase required age of Navcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNavcoin properly when installing Navcoin-Qt over it. (Windows)
