Navcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/navcoin/files/Navcoin/navcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Navcoin
...
New/changed settings (command-line or navcoin.conf file)
--------------------------------------------------------
