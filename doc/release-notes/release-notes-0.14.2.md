Navcoin Core version 0.14.2 is now available from:

  <https://navcoin.org/bin/navcoin-core-0.14.2/>
...
(in Navcoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Navcoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate navcoin-config.h as necessary (theuni)
