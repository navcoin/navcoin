Navcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/navcoin/files/Navcoin/navcoin-0.8.4/
...
code, causing the Navcoin-Qt or navcoind process to crash.
...
Linux: clicking on navcoin: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of Navcoin against Boost versions 1.50-1.52.
