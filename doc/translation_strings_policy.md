...
This document provides guidelines for internationalization of the Navcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `navcoin_en.ts` remains unchanged.
