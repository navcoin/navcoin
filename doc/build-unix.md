...
Note
---------------------
Always use absolute paths to configure and compile Navcoin Core and the dependencies.
...
To build Navcoin Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Otherwise, you can build Navcoin Core from self-compiled [depends](/depends/README.md).

**Note**: You only need Berkeley DB if the legacy wallet is enabled (see [*Disable-wallet mode*](#disable-wallet-mode)).

Security
--------
To help make your Navcoin Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Navcoin Core should be built with a non-executable stack,
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Navcoin Core can
...
`--with-incompatible-bdb` according to the [PKGBUILD](https://github.com/archlinux/svntogit-community/blob/packages/navcoin/trunk/PKGBUILD).
